...
const CONSUMER_KEY = '3CeLgTGDwrq4VYmzfpP8P3PwbL7npd4U30F23pue';
const CONSUMER_SECRET = 'cdnLoyZlJI7LK8ZwZ3y3qowIesOWaYJJExOsxWJF';
const TOKEN_URL = '/oauth/token';
const AUTHORIZE_URL = '/oauth/authorize';
const MY_CALLBACK_URL = 'http://localhost/callback';
